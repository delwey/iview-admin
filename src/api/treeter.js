export const findFromTree = (
  ...
  for (var i = 0; i < treeArray.length; i++) {
    if (treeArray[i][idPropName] === id) {
      ...
      let result = findFromTree(
        treeArray[i][childrenPropName],
        id,
        idPropName,
        childrenPropName
      )
...
export const deleteFromTree = (
  ...
  for (let i = 0; i < list.length; i++) {
    if (list[i][idPropName] === id) {
      ...
      let result = deleteFromTree(
        list[i][childrenPropName],
        id,
        idPropName,
        childrenPropName
      )
...
export const batchDeleteFromTree = (
  list,
  ids,
  idPropName = 'id',
  childrenPropName = 'children'
